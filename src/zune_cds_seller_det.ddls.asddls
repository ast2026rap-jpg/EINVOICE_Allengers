...
left outer join I_Address_2 as c on b.AddressID=c.AddressID
{
   key a.BillingDocument,
    a.SalesOrganization,
    case when a.SalesOrganization='80S0' then '08AAKCM8151H1Z6' 
         when a.SalesOrganization='90S0' then '08AAKCM8151H1Z6'  else '' end as sellerGSTIN,
   ...
   c.CityName as Loc,
  '302001' as Pin, 
     case when a.SalesOrganization='80S0' then '08' 
         when a.SalesOrganization='90S0' then '08'  else '  ' end as Stcd     
